              ...
              <div class="p-6">
                  ...
                  <form action="{{ route('department.store') }}" method="post">
                      ...
                      <div class="mb-4">
                          ...
                          <input type="description" name="description" class="w-full border border-gray-300 rounded-md px-3 py-2 mt-1 focus:outline-none focus:border-blue-500" value="{{ old('description') }}">
