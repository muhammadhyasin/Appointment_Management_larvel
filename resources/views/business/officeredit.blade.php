                ...
                <div class="p-6">
                    ...
                    <form action="{{ route('officer.update', $Officer->id) }}" method="post">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" class="w-full border border-gray-300 rounded-md px-3 py-2 mt-1 focus:outline-none focus:border-blue-500" value="{{ $Officer->name }}">
                            <div class="text-red-500">{{ $errors->first('name') }}</div>
                        </div>
    
                        <div class="mb-4">
                            <label for="email" class="block text-white">Email</label>
                            <input type="email" name="email" class="w-full border border-gray-300 rounded-md px-3 py-2 mt-1 focus:outline-none focus:border-blue-500" value="{{ $Officer->email }}">
