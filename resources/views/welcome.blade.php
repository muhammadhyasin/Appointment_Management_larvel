...
<div class="flex flex-col min-h-[100vh] bg-gray-950 text-gray-50">
        ...
        <div class="flex items-center gap-4">
                        ...
                        <nav class="-mx-3 flex flex-1 justify-end">
                            @auth
                                ...
                                <x-nav-link :href="route(Auth::user()->usertype . '.dashboard')" :active="request()->routeIs('dashboard')">
                                    {{ __('Dashboard') }}
                                </x-nav-link>
                                
                            @else
            <a 
                class="rounded-md px-4 py-2 text-sm font-medium transition-colors hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-gray-950"
                href="{{ route('register') }}"
            >
                Register
            </a>
    ...
    <main class="flex-1 flex items-center justify-center px-6 py-12">
        <div class="max-w-xl space-y-6 text-center">
            ...
            <p class="text-lg text-gray-400">Easily schedule appointments with our appointment booking system.</p>
            <a
